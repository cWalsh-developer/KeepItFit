    ...
    <Screen>
      ...
      {query.isLoading ? (
        ...
        query.data.map((item) => (
          <Link
            key={item.id}
            href={{ pathname: "/templates/[id]", params: { id: item.id } }}
            asChild
          >
        ...
        <EmptyState
          ...
          body="Create an unlimited number of reusable workouts."
        />
      )}
    </Screen>
  );
